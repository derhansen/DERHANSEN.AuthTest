...
/**
 * First test authentication provider
 */
class Test1Provider extends AbstractProvider {
	...
	public function getTokenClassNames() {
		return array('DERHANSEN\AuthTest\Security\Authentication\Token\Test1Token');
	}
	...
	public function authenticate(TokenInterface $authenticationToken) {
		if (!($authenticationToken instanceof \DERHANSEN\AuthTest\Security\Authentication\Token\Test1Token)) {
