...
/**
 * Test1 authentication token
 */
class Test1Token extends \TYPO3\Flow\Security\Authentication\Token\AbstractToken {
	 ...
	 *       __authentication[DERHANSEN][AuthTest][Security][Authentication][Token][Test1Token][password]
	 *
	...
	public function updateCredentials(\TYPO3\Flow\Mvc\ActionRequest $actionRequest) {
		...
		$password = \TYPO3\Flow\Reflection\ObjectAccess::getPropertyPath($arguments, '__authentication.DERHANSEN.AuthTest.Security.Authentication.Token.Test1Token.password');
		if (!empty($password)) {
